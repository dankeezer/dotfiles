...
curl -o /Users/$(whoami)/Library/Application\ Support/Sublime\ Text\ 3/Installed\ Packages/Package%20Control.sublime-package https://packagecontrol.io/Package%20Control.sublime-package
